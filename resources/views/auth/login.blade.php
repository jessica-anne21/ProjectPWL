<x-guest-layout>
    <div class="w-full max-w-md mx-auto mt-10 p-6 bg-white dark:bg-gray-900 shadow-md rounded-lg">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <a href="{{ route('login.mahasiswa') }}" class="flex items-center p-4 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition duration-300">
            ...
            <a href="{{ route('login.kaprodi') }}" class="flex items-center p-4 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition duration-300">
            ...
            <a href="{{ route('login.tata_usaha') }}" class="flex items-center p-4 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition duration-300">
