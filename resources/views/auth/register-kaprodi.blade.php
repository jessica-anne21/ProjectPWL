<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <input type="hidden" name="role" value="Ketua Prodi">


        <!-- Id Kaprodi -->
        <div>
            <x-input-label for="id_kaprodi" :value="__('Id Kaprodi')" />
            <x-text-input id="id_kaprodi" class="block mt-1 w-full" type="text" name="id_kaprodi" :value="old('id_kaprodi')" required autofocus />
            <x-input-error :messages="$errors->get('id_kaprodi')" class="mt-2" />
        </div>
